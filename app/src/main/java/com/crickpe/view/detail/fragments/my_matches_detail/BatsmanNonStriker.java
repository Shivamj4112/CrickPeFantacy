...
public final class BatsmanNonStriker {
    ...
    public /* synthetic */ BatsmanNonStriker(String str, String str2, int i, int i2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
