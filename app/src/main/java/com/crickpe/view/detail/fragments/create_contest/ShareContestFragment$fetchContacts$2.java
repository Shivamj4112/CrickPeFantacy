...
final class ShareContestFragment$fetchContacts$2 extends Lambda implements Function0<ArrayList<ContactRequest>> {
    final /* synthetic */ ShareContestFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ShareContestFragment$fetchContacts$2(ShareContestFragment shareContestFragment) {
        super(0);
