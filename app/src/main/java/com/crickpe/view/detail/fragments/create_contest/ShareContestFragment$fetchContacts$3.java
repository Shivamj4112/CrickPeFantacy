...
final class ShareContestFragment$fetchContacts$3 extends Lambda implements Function1<ArrayList<ContactRequest>, Unit> {
    final /* synthetic */ ShareContestFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ShareContestFragment$fetchContacts$3(ShareContestFragment shareContestFragment) {
        super(1);
    ...
    public final void invoke(ArrayList<ContactRequest> arrayList) {
        ...
        if (valueOf.booleanValue()) {
            ...
            if (!Intrinsics.areEqual((Object) contactListMain2, (Object) arrayList2)) {
                ...
                Log.v("List_Updated1", String.valueOf(obj));
            }
        }
    }
}
