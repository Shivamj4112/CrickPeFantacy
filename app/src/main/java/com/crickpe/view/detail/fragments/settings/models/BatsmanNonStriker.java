...
public final class BatsmanNonStriker {
    ...
    public static /* synthetic */ BatsmanNonStriker copy$default(BatsmanNonStriker batsmanNonStriker, String str, String str2, int i, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            str = batsmanNonStriker.player_key;
        }
        if ((i3 & 2) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.player_key, (Object) batsmanNonStriker.player_key) && Intrinsics.areEqual((Object) this.name, (Object) batsmanNonStriker.name) && this.ball == batsmanNonStriker.ball && this.run == batsmanNonStriker.run;
    }
    ...
    public String toString() {
        return "BatsmanNonStriker(player_key=" + this.player_key + ", name=" + this.name + ", ball=" + this.ball + ", run=" + this.run + ')';
    }
