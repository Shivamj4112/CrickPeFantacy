...
final class HomeActivity$fetchContacts$3 extends Lambda implements Function1<ArrayList<ContactRequest>, Unit> {
    public static final HomeActivity$fetchContacts$3 INSTANCE = new HomeActivity$fetchContacts$3();

    HomeActivity$fetchContacts$3() {
        super(1);
    }
