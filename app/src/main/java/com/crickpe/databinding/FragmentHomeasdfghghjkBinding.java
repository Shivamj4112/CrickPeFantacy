...
public final class FragmentHomeasdfghghjkBinding implements ViewBinding {
    ...
    private FragmentHomeasdfghghjkBinding(ConstraintLayout constraintLayout, ConstraintLayout constraintLayout2, CardView cardView, ImageView imageView, ImageView imageView4, ImageView imageView5, CircleImageView circleImageView, LinearLayout linearLayout4, LinearLayout linearLayout5, LinearLayout linearLayout6, LinearLayout linearLayout7, TextView textView, ConstraintLayout constraintLayout3, NestedScrollView nestedScrollView2, ProgressBar progressBar2, RelativeLayout relativeLayout, RelativeLayout relativeLayout2, RecyclerView recyclerView, RecyclerView recyclerView2, TextView textView2, TextView textView3, TextView textView4, TextView textView5, View view2, ViewPager viewPager, ViewPager viewPager2, WormDotsIndicator wormDotsIndicator, WormDotsIndicator wormDotsIndicator2) {
    ...
    public static FragmentHomeasdfghghjkBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static FragmentHomeasdfghghjkBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C1188R.C1193layout.fragment_homeasdfghghjk, viewGroup, false);
        if (z) {
    ...
    public static FragmentHomeasdfghghjkBinding bind(View view2) {
        View view3 = view2;
                                        ...
                                        if (linearLayout6 != null) {
                                            ...
                                            if (linearLayout7 != null) {
                                                ...
                                                if (textView != null) {
                                                    ...
                                                    NestedScrollView nestedScrollView2 = (NestedScrollView) ViewBindings.findChildViewById(view3, C1188R.C1192id.nestedScrollView);
                                                                                                    ...
                                                                                                    if (viewPager2 != null) {
                                                                                                        ...
                                                                                                        if (wormDotsIndicator != null) {
                                                                                                            ...
                                                                                                            if (wormDotsIndicator2 != null) {
                                                                                                                return new FragmentHomeasdfghghjkBinding(constraintLayout2, constraintLayout, cardView, imageView, imageView4, imageView5, circleImageView, linearLayout4, linearLayout5, linearLayout6, linearLayout7, textView, constraintLayout2, nestedScrollView2, progressBar2, relativeLayout, relativeLayout2, recyclerView, recyclerView2, textView2, textView3, textView4, textView5, findChildViewById, viewPager, viewPager2, wormDotsIndicator, wormDotsIndicator2);
                                                                                                            }
                                                                                                        }
                                                                                                    }
                                                                                                }
