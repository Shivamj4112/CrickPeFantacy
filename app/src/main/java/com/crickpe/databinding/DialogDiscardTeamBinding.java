...
public final class DialogDiscardTeamBinding implements ViewBinding {
    ...
    private DialogDiscardTeamBinding(CardView cardView, LinearLayout linearLayout, TextView textView, TextView textView2, TextView textView3, View view2) {
    ...
    public static DialogDiscardTeamBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static DialogDiscardTeamBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(C1188R.C1193layout.dialog_discard_team, viewGroup, false);
        if (z) {
    ...
    public static DialogDiscardTeamBinding bind(View view2) {
                ...
                if (textView2 != null) {
                    ...
                    if (textView3 != null) {
                        ...
                        if (findChildViewById != null) {
                            return new DialogDiscardTeamBinding((CardView) view2, linearLayout, textView, textView2, textView3, findChildViewById);
                        }
                    }
                }
            }
